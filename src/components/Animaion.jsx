...
export default function Animaion() {
  const API = "http://localhost:8080/api/animation";
    ...
    <div className="border rounded-lg shadow-md p-4 bg-white min-h-[460px] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4 border-b pb-2">
        <div className="flex items-center gap-2">
          <img src={Animation} alt="tiktok" className="w-6 h-6" />
          <h2 className="text-xl font-bold text-gray-800">애니메이션</h2>
        </div>
        {links.length > 5 && (
          <button
