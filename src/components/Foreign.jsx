...
import foreign from "../assets/foregin.png";
import NumberBox from "./NumberBox";

export default function Foreign() {
  const API = "http://localhost:8080/api/foreign";
    ...
    <div className="border rounded-lg shadow-md p-4 bg-white min-h-[460px] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4 border-b pb-2">
        <div className="flex items-center gap-2">
          <img src={foreign} alt="foreign" className="w-6 h-6" />
          <h2 className="text-xl font-bold text-gray-800">해외 성인</h2>
        </div>
        {links.length > 5 && (
          <button
