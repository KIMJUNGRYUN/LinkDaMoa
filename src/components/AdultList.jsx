...
import nineteenIcon from "../assets/19.png";
import NumberBox from "../components/NumberBox"; 

export default function AdultList() {
  const API = "http://localhost:8080/api/adult";
    ...
    <div className="border rounded-lg shadow-md p-4 bg-white min-h-[460px] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4 border-b pb-2">
        <div className="flex items-center gap-2">
          <img src={nineteenIcon} alt="19" className="w-6 h-6" />
          <h2 className="text-xl font-bold text-gray-800">성인</h2>
        </div>
        {links.length > 5 && (
          <button
